...
partial record struct ColorByteWrap : Serde.IDeserialize<ColorByteWrap, ColorByte>
{
    static ColorByte Serde.IDeserialize<ColorByteWrap, ColorByte>.Deserialize<D>(ref D deserializer)
    {
