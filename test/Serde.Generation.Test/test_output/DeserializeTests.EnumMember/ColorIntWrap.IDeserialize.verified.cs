...
partial record struct ColorIntWrap : Serde.IDeserialize<ColorIntWrap, ColorInt>
{
    static ColorInt Serde.IDeserialize<ColorIntWrap, ColorInt>.Deserialize<D>(ref D deserializer)
    {
