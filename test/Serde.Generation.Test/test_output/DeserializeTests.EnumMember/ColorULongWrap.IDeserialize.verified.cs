...
partial record struct ColorULongWrap : Serde.IDeserialize<ColorULongWrap, ColorULong>
{
    static ColorULong Serde.IDeserialize<ColorULongWrap, ColorULong>.Deserialize<D>(ref D deserializer)
    {
