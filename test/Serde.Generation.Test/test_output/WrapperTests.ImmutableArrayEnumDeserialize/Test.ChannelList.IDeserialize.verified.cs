...
namespace Test
{
    partial record struct ChannelList : Serde.IDeserialize<Test.ChannelList, Test.ChannelList>
    {
        static Test.ChannelList Serde.IDeserialize<Test.ChannelList, Test.ChannelList>.Deserialize<D>(ref D deserializer)
        {
